...
gfx = Graphics(MAP_DIMENSIONS, 'bot.png', 'background.png')
start = (200, 200)
robot = Robot(start, 0.01*3779.52)
sensor_range = 250, math.radians(40)
uiltra_sonic = Ultrasonic(sensor_range, gfx.map)
...
while running:
    ...
    point_cloud = uiltra_sonic.sense_obstacles(robot.x, robot.y, robot.heading)
